...
contract RemembraMarkHookTest is BaseTest {
    ...
    function setUp() public {
        ...
        // Deploy hook with correct permissions encoded in address
    ...
    function testCannotResolveWhenNotEligible() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(RemembraMarkHook.MarkNotEligibleForResolution.selector, fakeMarkId));
